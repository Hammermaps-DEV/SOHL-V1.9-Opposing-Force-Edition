...
typedef GLvoid      (APIENTRY * PFNGLBINDBUFFERPROC) (enum target, GLuint buffer);
...
typedef GLvoid      (APIENTRY * PFNGLBUFFERDATAPROC) (enum target, GLsizeiptrARB size, const GLvoid *data, enum usage);
typedef GLvoid      (APIENTRY * PFNGLBUFFERSUBDATAPROC) (enum target, GLintptrARB offset, GLsizeiptrARB size, const GLvoid *data);
typedef GLvoid      (APIENTRY * PFNGLGETBUFFERSUBDATAPROC) (enum target, GLintptrARB offset, GLsizeiptrARB size, GLvoid *data);
typedef GLvoid *    (APIENTRY * PFNGLMAPBUFFERPROC) (enum target, enum access);
typedef GLboolean   (APIENTRY * PFNGLUNMAPBUFFERPROC) (enum target);
typedef GLvoid      (APIENTRY * PFNGLGETBUFFERPARAMETERIVPROC) (enum target, enum pname, int *params);
typedef GLvoid      (APIENTRY * PFNGLGETBUFFERPOINTERVPROC) (enum target, enum pname, GLvoid **params);
