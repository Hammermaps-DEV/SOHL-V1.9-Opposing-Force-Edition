...
typedef struct cl_enginefuncs_s
{
	...
	int							( *pfnSPR_Frames )			( HL_HSPRITE hPic );
	int							( *pfnSPR_Height )			( HL_HSPRITE hPic, int frame );
	int							( *pfnSPR_Width )			( HL_HSPRITE hPic, int frame );
	void						( *pfnSPR_Set )				( HL_HSPRITE hPic, int r, int g, int b );
	...
	void						( *pfnSetCrosshair )		( HL_HSPRITE hspr, wrect_t rc, int r, int g, int b );
...
// Added for user input processing
	...
	const struct model_s *		( *GetSpritePointer )		( HL_HSPRITE hSprite );
