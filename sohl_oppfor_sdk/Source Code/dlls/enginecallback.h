...
#define STRING_ENGINE		(*g_engfuncs.pfnSzFromIndex)
//#define ALLOC_STRING	(*g_engfuncs.pfnAllocString)
// Use this instead of ALLOC_STRING on constant strings
#define MAKE_STRING_ENGINE(str)	((int)(str) - (int)(STRING_ENGINE(0)))

inline int ALLOC_STRING(const char* pszString)
{
	char* pszBuffer = const_cast<char*>(STRING_ENGINE(g_engfuncs.pfnAllocString(pszString)));
	...
	return MAKE_STRING_ENGINE(pszBuffer);
}
