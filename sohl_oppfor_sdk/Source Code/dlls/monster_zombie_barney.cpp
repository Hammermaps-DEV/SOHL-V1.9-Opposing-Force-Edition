...
#define ZOMBIE_BARNEY_FLINCH_DELAY			1.5		// at most one flinch every n secs
...
void CZombieBarney::HandleAnimEvent(MonsterEvent_t *pEvent)
{
	...
	case ZOMBIE_BARNEY_AE_ATTACK_RIGHT:
	{
		...
		CBaseEntity *pHurt = CheckTraceHullAttack(70, 1/*gSkillData.zombieBarneyDmgOneSlash*/, DMG_SLASH);
		if (pHurt)
		{
	...
	{
		// do stuff for this event.
		CBaseEntity *pHurt = CheckTraceHullAttack(70, 1/*gSkillData.zombieBarneyDmgBothSlash*/, DMG_SLASH);
		if (pHurt)
		{
			if (pHurt->pev->flags & (FL_MONSTER | FL_CLIENT))
			{
...
void CZombieBarney::Spawn()
{
	...
	if (pev->health == 0)
		pev->health = 20;/*gSkillData.zombieBarneyHealth;*/
