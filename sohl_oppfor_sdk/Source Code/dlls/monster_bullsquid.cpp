...
void CSquidSpit::Touch(CBaseEntity *pOther)
{
	...
	EMIT_SOUND_DYN(ENT(pev), CHAN_VOICE, "bullchicken/bc_acid1.wav", VOL_NORM, ATTN_NORM, 0, iPitch);
...
BOOL CBullsquid::CheckRangeAttack1(float flDot, float flDist)
{
	...
	if (flDist > 64 && flDist <= 784 && flDot >= 0.5 && UTIL_GlobalTimeBase() >= m_flNextSpitTime)
	{
		if (m_hEnemy != NULL)
		{
			if (V_fabs(pev->origin.z - m_hEnemy->pev->origin.z) > 256)
			{
...
void CBullsquid::IdleSound(void)
{
	...
	{
	case 0:
		EMIT_SOUND(ENT(pev), CHAN_VOICE, "bullchicken/bc_idle1.wav", VOL_NORM, SQUID_ATTN_IDLE);
		break;
	case 1:
		EMIT_SOUND(ENT(pev), CHAN_VOICE, "bullchicken/bc_idle2.wav", VOL_NORM, SQUID_ATTN_IDLE);
		break;
	case 2:
		EMIT_SOUND(ENT(pev), CHAN_VOICE, "bullchicken/bc_idle3.wav", VOL_NORM, SQUID_ATTN_IDLE);
		break;
	case 3:
		EMIT_SOUND(ENT(pev), CHAN_VOICE, "bullchicken/bc_idle4.wav", VOL_NORM, SQUID_ATTN_IDLE);
		break;
	case 4:
		EMIT_SOUND(ENT(pev), CHAN_VOICE, "bullchicken/bc_idle5.wav", VOL_NORM, SQUID_ATTN_IDLE);
		break;
	}
}
...
void CBullsquid::PainSound(void)
{
	...
	{
	case 0:
		EMIT_SOUND_DYN(ENT(pev), CHAN_VOICE, "bullchicken/bc_pain1.wav", VOL_NORM, ATTN_NORM, 0, iPitch);
		break;
	case 1:
		EMIT_SOUND_DYN(ENT(pev), CHAN_VOICE, "bullchicken/bc_pain2.wav", VOL_NORM, ATTN_NORM, 0, iPitch);
		break;
	case 2:
		EMIT_SOUND_DYN(ENT(pev), CHAN_VOICE, "bullchicken/bc_pain3.wav", VOL_NORM, ATTN_NORM, 0, iPitch);
		break;
	case 3:
		EMIT_SOUND_DYN(ENT(pev), CHAN_VOICE, "bullchicken/bc_pain4.wav", VOL_NORM, ATTN_NORM, 0, iPitch);
		break;
	}
}
...
void CBullsquid::AlertSound(void)
{
	...
	{
	case 0:
		EMIT_SOUND_DYN(ENT(pev), CHAN_VOICE, "bullchicken/bc_idle1.wav", VOL_NORM, ATTN_NORM, 0, iPitch);
		break;
	case 1:
		EMIT_SOUND_DYN(ENT(pev), CHAN_VOICE, "bullchicken/bc_idle2.wav", VOL_NORM, ATTN_NORM, 0, iPitch);
		break;
	}
}
...
void CBullsquid::DeathSound(void)
{
	...
	{
	case 0:
		EMIT_SOUND(ENT(pev), CHAN_VOICE, "bullchicken/bc_die1.wav", VOL_NORM, ATTN_NORM);
		break;
	case 1:
		EMIT_SOUND(ENT(pev), CHAN_VOICE, "bullchicken/bc_die2.wav", VOL_NORM, ATTN_NORM);
		break;
	case 2:
		EMIT_SOUND(ENT(pev), CHAN_VOICE, "bullchicken/bc_die3.wav", VOL_NORM, ATTN_NORM);
		break;
	}
}
...
void CBullsquid::StartTask(Task_t *pTask)
{
	...
	case TASK_MELEE_ATTACK2:
	{
		...
		{
		case 0:
			EMIT_SOUND(ENT(pev), CHAN_VOICE, "bullchicken/bc_attackgrowl.wav", VOL_NORM, ATTN_NORM);
			break;
		case 1:
			EMIT_SOUND(ENT(pev), CHAN_VOICE, "bullchicken/bc_attackgrowl2.wav", VOL_NORM, ATTN_NORM);
			break;
		case 2:
			EMIT_SOUND(ENT(pev), CHAN_VOICE, "bullchicken/bc_attackgrowl3.wav", VOL_NORM, ATTN_NORM);
			break;
		}
